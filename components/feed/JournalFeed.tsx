  ...
  return (
    <>
      <p className="mb-3 text-xs text-slate-500">
        Each card is one day. <strong className="text-slate-600">Mood</strong>{" "}
        is self-reported on a 1–10 scale (1 = worst, 10 = best);{" "}
      ...
      <div className="grid gap-3 sm:grid-cols-2">
        {entries.map((e) => (
          <JournalEntryCard
            ...
            flaggedRisk={
              riskDate === e.date || e.precomputed_signals?.risk_flag === true
            }
          />
        ))}
      </div>
